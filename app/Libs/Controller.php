...
class Controller
{
    ...
    {
        $exit_model = array('categories', 'plant', 'brand', 'wishlist', 'coupon', 'productimages', 'orderitem', 'user', 'shop', 'auth', 'admin', 'cart', 'category', 'contact', 'customer', 'order', 'orderdetail', 'orders', 'product', 'slide', 'room');
